...
/**
 * Defines a service capable of performing bytecode transformations on classes during the game bootstrap lifecycle.
 *
 * <p>Implementations may participate in one or more
 * {@link TransformPhase transformation phases} and are invoked in priority order within each phase.</p>
 */
public interface TransformationService {

    /**
     * Invoked after mixin has completed its bootstrap, but before the game init begins.
     *
    ...
    /**
     * Returns the execution priority of this transformer for the given {@link TransformPhase}.
     *
     * <p>Lower values indicate earlier execution. A return value of
     * {@code -1} indicates that this transformer shouldn't be executed in the specified phase.</p>
     *
    ...
    /**
     * Determines whether this transformer should be applied to the specified class.
     *
     * @param type
     *     the ASM type representing the class
     * @param node
     *     the class node
     *
    ...
    /**
     * Attempts to transform the specified class during the given {@link TransformPhase}.
     *
     * <p>If the transformer makes no modifications, this method must
     * return {@code null}. If modifications are made, the modified {@link ClassNode} must be returned.</p>
     *
     * @param type
     *     the ASM type representing the class
     * @param node
     *     the class node to transform
     * @param phase
     ...
     *
     * @throws Throwable
     *     if an unrecoverable error occurs during transformation
     */
