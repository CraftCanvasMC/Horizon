...
public interface JavaInstrumentation {
    ...
    /**
     * Adds a jar to the system classloader. It is however recommended to use
     * {@link EmberClassLoader#tryAddToHorizonSystemLoader(Path)}
     *
     * @param jar
     *     the jar file
     *
     * @throws IllegalStateException
     *     if the instrumentation failed to boot or was unable to add
     */
     ...
     *
     * @throws IllegalStateException
     *     if the instrumentation failed to boot
     */
    void checkSuccess();
