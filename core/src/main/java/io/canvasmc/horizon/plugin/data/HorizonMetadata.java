 ...
 * @param apiVersion
 *     the minimum api version the plugin supports
 * @param mixins
 *     the mixin entry names for the plugin
 * @param accessWideners
 *     the widener entry names for the plugin
 * @param loadDatapackEntry
 *     if the plugin should be registered as a datapack entry
 */
