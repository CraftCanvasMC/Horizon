...
import io.canvasmc.horizon.util.constants.RUNTIME_PLUGIN_CONFIG
...
fun Project.setupRunPaperCompat(userdevExt: PaperweightUserExtension, horizonExt: HorizonExtension, progressLoggerFactory: ProgressLoggerFactory) {
    ...
    val runtimePlugins = configurations.named(RUNTIME_PLUGIN_CONFIG)
    ...
    tasks.withType<RunServer>().configureEach {
        ...
        pluginJars.from(runtimePlugins.map { it.libraryJars() })
        doFirst {
